...
export default function RootLayout({
  ...
  return (
    <html lang="zh" suppressHydrationWarning>
      ...
      <body suppressHydrationWarning className="page-wrapper">
